        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto mb-4 leading-relaxed">
              为 React 打造的 <span className="font-semibold text-primary-600 dark:text-primary-400">现代化</span> 组件库
            </p>

            <p className="text-lg text-gray-500 dark:text-gray-400 max-w-3xl mx-auto mb-12">
              开源、类型安全的组件库，基于 Tailwind CSS 构建，为您的应用提供精美的 UI 组件
            </p>

            {/* 行动按钮 */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <a href={getPath("/docs")} className="group">
                <Button size="lg" className="px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                  开始使用
              ...
              <a href="https://github.com/l630630/Kitty" target="_blank" rel="noopener noreferrer" className="group">
                <Button variant="outline" size="lg" className="px-8 py-4 text-lg font-semibold border-2 hover:scale-105 transition-all duration-300">
            ...
            <div className="max-w-2xl mx-auto">
              <p className="text-xl text-gray-500 dark:text-gray-400 mb-4">快速安装</p>
                ...
                <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 mb-6">
                  <div className="space-y-3">
                    <Checkbox
                      ...
                      onChange={(e) =>
                        setCheckboxStates(prev => ({ ...prev, basic: e.target.checked }))
                      }
                      label="基础选项"
                      size="sm"
                      color="green"
                    ...
                    <Checkbox
                      ...
                      onChange={(e) =>
                        setCheckboxStates(prev => ({ ...prev, advanced: e.target.checked }))
                      }
                      label="高级选项"
                      size="sm"
                      color="green"
          ...
          <section className="card rounded-2xl p-12 shadow-sm transition-all duration-300">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100 transition-theme duration-300">安装</h3>
                  ...
                  <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100 transition-theme duration-300">使用</h3>
